      ...
      <main className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8 py-10">
        ...
        <div className="mt-8 rounded-2xl border border-neutral-200 shadow-sm overflow-hidden">
          ...
          <form onSubmit={onSubmit} className="p-6 sm:p-8 space-y-6" autoComplete="off">
            ...
            {/* Submit */}
            <div className="pt-4">
              <button type="submit" disabled={loading || !agreeTos} className="w-full h-12 rounded-xl bg-gradient-to-r from-indigo-600 via-purple-600 to-fuchsia-500 px-6 font-semibold text-white shadow-md hover:opacity-90 disabled:opacity-60 disabled:cursor-not-allowed transition flex items-center justify-center gap-2">
                {loading ? (
